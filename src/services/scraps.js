...
export async function queryScraps(params) {
...
export async function queryInfo(params) {
  return request(`/api/scraps/${params.id}`)
}

export async function firstCheck(params) {
  return request(`/api/scraps/${params.id}/firstCheck`, {
    method: "PATCH",
    data: {
...
export async function secondCheck(params) {
  return request(`/api/scraps/${params.id}/secondCheck`, {
    method: "PATCH",
    data: {
      status: params.status,
    }
