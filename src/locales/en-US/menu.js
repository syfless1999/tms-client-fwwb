export default {
  ...
  'menu.bills':'Bills',
  'menu.tdef':'Tools',
  'menu.dashboard':'Data Analysis',
  'menu.editorMap':'Map Editor',
  'menu.bills.list':'Bill List',
  'menu.bills.append': 'Append Bill',
  'menu.repairs.list': 'Repair List',
  'menu.repairs.append': 'Append Repair',
  'menu.userManage': 'User Manage',
  'menu.repairs': 'Repair',
  // 'menu.repairs.list': 'Repair List',
  // 'menu.repairs.append': 'Append Repair',
  'menu.accountsettings':'accountsettings',
  'menu.accountcenter':'accountcenter',
  'menu.changetdefs':'changetdefs',
